...
if __name__ == "__main__":
    #
    for checkpoint_name in ["baseline", "weighted","balanced"]:
        device = "cuda" if torch.cuda.is_available() else "cpu"
        checkpoint_path = f"checkpoints//{checkpoint_name}//mil_model_best.pth" #path
        ...
        for bag_values in attentions:
            scores.append(normalize(bag_values))
